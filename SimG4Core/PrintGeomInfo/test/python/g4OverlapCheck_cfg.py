...
#process.load('Configuration.Geometry.GeometryExtended2026D53_cff')
process.load('Configuration.Geometry.GeometryExtended2026D56_cff')
...
process.g4SimHits.G4CheckOverlap.OutputBaseName = cms.string("cms2026")
...
# list of names
process.g4SimHits.G4CheckOverlap.NodeNames  = cms.vstring('CALOEC')
